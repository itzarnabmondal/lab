...
//        if (Validation.balance(StudentInfo.getStudentId()) > 1) {
//            System.err.println("You have Rs: "+Validation.balance(StudentInfo.getStudentId())+" left on your account!");
...
//        byte count = (byte) st.executeUpdate("delete from bankinfo where accountno="+ StudentInfo.getStudentId());
//
//        // Showing result
//        if (count > 0) {
//
