...
//            StudentInfo.setPasswordHash(Security.getSha256(input));
//        }
//
...
//        byte count = (byte) st.executeUpdate("update bankinfo set passwordhash="+ StudentInfo.getPasswordHash()+"where accountno="+ StudentInfo.getStudentId());
//
