...
public class CreateAccount {
    ...
    public static void createAccount() throws Exception {
        ...
        ps.setString(5, StudentInfo.getPasswordHash());
        ps.setString(9, StudentInfo.getRecoveryKeyHash());
        ps.setString(10, StudentInfo.getPinHash());
        ps.setBoolean(11, StudentInfo.isIsPinEnabled());
