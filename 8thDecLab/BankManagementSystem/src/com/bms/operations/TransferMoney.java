...
public class TransferMoney {
    ...
    private static void takeReceiverDetails() throws Exception {
        ...
        try {
            receiverAccountNo = new Scanner(System.in).nextInt();
        }
        ...
        try {
            receiverPhoneNumber = new Scanner(System.in).nextLong();
        }
        catch (InputMismatchException e) {
    ...
    private static void transfer() throws Exception {
        ...
        if (transferAmount <= Validation.balance(CustomerInfo.getAccountNo())) {
            ...
            int count = st.executeUpdate("update bankinfo set balance="+(Validation.balance(receiverAccountNo) + transferAmount)+" where accountno="+receiverAccountNo);
